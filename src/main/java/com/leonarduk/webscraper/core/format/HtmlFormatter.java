...
public class HtmlFormatter implements Formatter {
     ...
     * (non-Javadoc)
     * @see
     * com.leonarduk.itemfinder.format.Formatter#formatHeader(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.leonarduk.itemfinder.format.Formatter#formatLink(java.lang.String,
     * java.lang.String)
     */
    @Override
    public final String formatLink(final String link, final String name) {
        final StringBuilder linkBuilder =
                new StringBuilder("<a href=\"" + link + "\">");
