    ...
    public final void processMail(
        ...
        try {
            ...
            for (final Message message : messages) {
                final EmailMessageBuilder emailMessageBuilder =
                ...
                if (messagecontentObject instanceof Multipart) {
                    ...
                    for (int i = 0; i < multipart.getCount(); i++) {
                        ...
                        if (contentType.startsWith("text/plain")) {
                            emailMessageBuilder.addContent(part.getContent()
                                    .toString());
                        }
                        else {
                            // Retrieve the file name
                            final String attachmentPath =
                                    attachmentsDirectory + File.separator
                                            + part.getFileName();
                    ...
                    subject = message.getSubject();
                    emailMessageBuilder.setSubject(subject);
                    emailMessageBuilder.addContent(messagecontentObject
                            .toString());
                }
            ...
            store.close();
                ...
                | FolderNotFoundException | NoSuchProviderException
                | ReadOnlyFolderException | StoreClosedException e) {
